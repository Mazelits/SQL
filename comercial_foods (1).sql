...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-03-2024 a las 16:07:02
...
(2, 'Panaderia', 'panes y reposteria'),
...
(7, 'Carnes Frias', 'Salchichas, mortadelas y jamones');
...
CREATE TABLE `cliente` (
  ...
  `tipo_documento` enum('c','ce','nit','cut') DEFAULT NULL,
...
(1, 'Mario', 'Alexis', 'Aroca', 'Martínez', '', '1122239857', 'masculino', 'CALLE 40 SUR #96-16', 'Bogota', '2024-03-11', 38, '3158097309', 'soltero', 'mayorista', 'A', 3),
(2, 'Jerónimo', '', 'burgos', 'diez', '', '10000459', 'masculino', 'CRA 98 # 58-90', 'Bogota', '2024-03-11', 40, '9015872', 'soltero', '', 'A', 3),
(3, 'Estefanía', 'Tatiana', 'Villegas', 'sierra', '', '1023581203', 'femenino', 'TRV 110 #81-40', 'Bogota', '2024-03-11', 32, '6047599', 'casado', 'mayorista', 'A', 4),
(4, 'Guillermo', 'Mauricio', 'Fernandez', 'Vallejo', '', '125692614', 'masculino', 'CALLE 75 #23SUR-40', 'Barranquilla', '2024-03-11', 43, '7057522', 'soltero', 'mayorista', 'A', 4),
(5, 'Eliana', 'Marcela', 'Ramírez', 'Guerrero', 'nit', '1222333445', 'femenino', 'Calle 181 #2-45 ', 'Barranquilla', '2024-03-11', 50, '8019053', 'viudo', 'mayorista', 'A', 5),
(6, 'José', 'Gregorio', 'Carmona', 'Guerra', '', '1091562345', 'masculino', 'Cra 3 A # 5-89', 'Barranquilla', '2024-03-11', 29, '3134409180', 'casado', 'detallista', 'A', 5),
(7, 'Marcela', 'Eliana', 'De santis', 'Rodríguez', '', '1091562348', 'femenino', 'calle 9b # 4-20', 'Cali', '2024-03-11', 35, '3108156310', '', 'mayorista', 'A', 6),
(8, 'Daniela', '', 'Franco', 'Marulanda', '', '1091562312', 'femenino', 'Carrera 56A No. 51 - 81', 'Cali', '2024-03-11', 45, '3212598228', '', 'mayorista', 'A', 6),
(9, 'Rafael', 'Fabian', 'Cortes', 'Palacio', '', '1091562336', 'masculino', 'Calle 10 No. 9 - 78 Centro', 'Medellin', '2024-03-11', 48, '7586412', 'soltero', 'mayorista', 'A', 7),
(10, 'Camilo', 'Andres', 'Berrios', 'Bermudez', '', '1091562314', 'masculino', 'Calle 24D #5676', 'Medellin', '2024-03-11', 36, '4341235', 'casado', 'mayorista', 'A', 7),
(11, 'Francisco', 'David', 'Arias', 'Toledo', '', '1091562349', 'masculino', 'calle 5b #78c 05', 'Bogota', '2024-03-11', 27, '6018954', 'casado', '', 'A', 8),
(12, 'Antonio', 'Giovanny', 'Merizalde', 'Arango', '', '1091562103', 'masculino', 'Calle 23 #54-9', 'Barranquilla', '2024-03-11', 53, '3165846257', 'viudo', 'mayorista', 'A', 8),
(13, 'Karen', 'Rocio', 'Restrepo', 'Acevedo', '', '1091562425', 'femenino', 'cra 7a # 34-89sur', 'Barranquilla', '2024-03-11', 43, '8017936', 'viudo', 'detallista', 'A', 9),
(14, 'David', 'Santiago', 'Lemus', 'Cock', 'nit', '1112239564', 'masculino', 'cr 5a #20-34 sur', 'Bogota', '2024-03-11', 55, '3412658975', 'soltero', 'mayorista', 'A', 9),
(15, 'Javier', 'Mauricio', 'Santana', 'Casadiegos', '', '1233669874', 'masculino', 'CALLE 27 #58-63', 'Cali', '2024-03-11', 40, '315648301', 'casado', 'mayorista', 'A', 10),
(16, 'Virginia', '', 'Saldarriaga', 'Salamanca', '', '1556998745', 'femenino', 'cll 36 3 1-81 este', 'Medellin', '2024-03-11', 38, '4518992', 'casado', 'detallista', 'A', 10);
...
CREATE TABLE `empleado` (
  ...
  `apellido1` varchar(25) NOT NULL,
  `apellido2` varchar(25) NOT NULL,
  `tipo_documento` enum('cc','ce','nit','cut') DEFAULT NULL,
  `no_documento` varchar(25) NOT NULL,
  `sexo` enum('masculino','femenino') DEFAULT NULL,
  `direccion` varchar(50) NOT NULL,
  `ciudad` varchar(20) NOT NULL,
...
(1, 'Gonzalo', '', 'Betancur', 'Arroyave', 'cc', '80161094', 'masculino', 'cra 78c # 5c 48', 'bogota', 30, '3145778421', '2024-03-11', 'soltero', 1, '', 'sanitas', 'colfondos', 'fna', 'BBVA', 'A'),
(2, 'Santiago', '', 'Betancurt', 'Lemos', 'cc', '79843321', 'masculino', 'cra 71d # 7a 48', 'bogota', 32, '3202568945', '2024-03-11', 'casado', 1, 'tecnico', 'sura', 'proteccion', 'porvenir', 'davivienda', 'A'),
(3, 'Isabella', '', 'Marquez', 'Jaramillo', 'cc', '52951079', 'femenino', 'CALLE 28 #58-69', 'barranquilla', 28, '3457634512', '2024-03-11', 'viudo', 2, '', 'capital salud', 'colfondos', 'colfondos', '', 'A'),
(4, 'Karla', 'Maria', 'Molina', 'Lema', 'cc', '53456798', 'femenino', 'cra 78c # 5c 25', 'cali', 34, '3124772431', '2024-03-11', 'casado', 2, 'tecnico', 'nueva eps', 'proteccion', 'fna', 'popular', 'A'),
(5, 'Hilda', '', 'Rodriguez', 'Caro', 'cc', '1020567980', 'femenino', 'Av 68 # 5a _45', 'bogota', 31, '3025975960', '2024-03-11', 'casado', 2, '', 'sanitas', 'porvenir', 'proteccion', '', 'A'),
(6, 'Victoria', '', 'Hincapie', 'Vergara', 'cc', '19654789', 'femenino', 'Calle 10 # 5-51', 'medellin', 22, '3103336590', '2024-03-11', 'union libre', 2, '', 'sura', 'porvenir', 'colfondos', 'popular', 'A'),
(7, 'Pablo', 'Santiago', 'Rojas', 'Duque', 'cc', '1018765324', 'masculino', 'Calle 100 # 11B-27 Bogotá', 'bogota', 25, '3456676895', '2024-03-11', 'soltero', 2, 'tecnico', 'capital salud', 'colfondos', 'fna', 'davivienda', 'A'),
(8, 'Pamela', '', 'Serna', 'Muñoz', 'cc', '1010654382', 'femenino', 'Calle 53 No 10-60/46, Pis', 'barranquilla', 40, '3225986478', '2024-03-11', 'union libre', 2, 'tecnico', 'nueva eps', 'skandia', 'porvenir', 'BBVA', 'A'),
(9, 'Stephania', '', 'Zapata', 'Pelaez', 'cc', '1014343567', 'femenino', 'Carrera 21 # 17 -63', 'cali', 25, '3028912345', '2024-03-11', 'casado', 2, '', 'sanitas', 'porvenir', 'fna', 'davivienda', 'A'),
(10, 'Manuel', 'Andres', 'Toro', 'Sanchez', 'cc', '1013567900', 'masculino', 'Calle 24D #5676', 'medellin', 28, '3026598745', '2024-03-11', 'casado', 2, '', 'sura', 'skandia', 'colfondos', 'popular', 'A'),
(11, 'Barbara', '', 'Henao', 'Cano', 'cc', '51593856', 'femenino', 'CALLE 12#45-17', 'bogota', 35, '8018043009', '2024-03-11', 'viudo', 4, '', 'capital salud', 'colfondos', 'colfondos', '', 'A'),
(12, 'Leonardo', '', 'Vasquez', 'Uribe', 'cc', '79804568', 'masculino', 'Av 26 No 59-51 Edificio A', 'medellin', 24, '3201452698', '2024-03-11', 'union libre', 4, 'tecnico', 'nueva eps', 'proteccion', 'proteccion', '', 'A'),
(13, 'Juliana', '', 'Castrillón', 'Florez', 'cc', '1015678904', 'femenino', 'Av Boyaca #  2a 71', 'cali', 32, '3412589678', '2024-03-11', 'soltero', 3, '', 'sanitas', 'colfondos', 'colfondos', 'davivienda', 'A'),
(14, 'Rocio', '', 'Muñoz', 'Gutierrez', 'cc', '1015768903', 'femenino', 'CR 5B #50-49A SUR', 'barranquilla', 37, '3125847512', '2024-03-11', 'casado', 3, 'tecnico', 'sura', 'porvenir', 'porvenir', 'BBVA', 'A');
...
--
ALTER TABLE `productos`
  ADD CONSTRAINT `productos_ibfk_1` FOREIGN KEY (`categoria_cod`) REFERENCES `categoria` (`cod_categoria`) ON DELETE CASCADE ON UPDATE CASCADE,
